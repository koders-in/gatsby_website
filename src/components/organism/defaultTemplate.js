...
import { ContainerHeaderStyle, ContainerContent, DefaultContainerStyle, HeaderTextStyle } from './defaultTemplate.style';
import { Header1, Paragraph } from '../atoms/header';

const DefaultTemplate = ( { children, title, quote, primary, secondary, isCustomer, isBlog } ) => {
  return (
