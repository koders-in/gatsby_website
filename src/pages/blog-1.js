...
const blogPage = () => (
  <ThemeProvider theme={ defaultTheme }>
     <>
     Covid-19 and your forgotten quest to start a blog
...
While the pandemic has affected more than 200 countries around the globe and putting half of those in a lockdown, it has not yet shown any signs of slowing down.
As they say, Innovation is the need of the hour. People are finding new ways to spend their time at home. While some are busy and bored with social media platforms like Tik-Tok, Facebook, Instagram etc. others went on a nostalgic voyage of finding their long-lost passion of cooking and learning new things. Oh, and if you think there has been no innovation regarding this, you are not a man of culture. Please, follow memes. People are being more creative than usual. I mean the recent funeral service meme is just hilarious. Anyway, one such passion as we have seen is blogging. I do not think, any other time will be more suitable for getting started on it and to go viral. Second to memes, of course.
If you like to know how to write a blog, at Koders we have a tutorial/how-to section dedicated to it. Check it out.
In this time of self-isolation and social distancing, which hitherto is the only way to halt the possible spread of coronavirus, the little we can do to keep our sanity intact is by writing or sharing our experiences with the world. And a little trade secret for you, people have been doing it for a while. It is your turn to rise and shine now. Hurry up and get started! There will never be a perfect time.
  </>
  </ThemeProvider>
);
